      ...
      formulaInput(new QLineEdit(this))
{
    ...
    setWindowTitle(tr("Affichage courses"));
}
...
void SpreadSheet::setupContents()
{
    ...
    // column 0
    table->setItem(0, 0, new SpreadSheetItem("Label"));
    table->item(0, 0)->setBackground(titleBackground);
    table->item(0, 0)->setToolTip("Cette colonne décrit ");
    table->item(0, 0)->setFont(titleFont);

    table->setItem(1, 0, new SpreadSheetItem("Joueur 1"));
    table->setItem(2, 0, new SpreadSheetItem("Joueur 14"));
    table->setItem(3, 0, new SpreadSheetItem("Ballon"));
    ...
    // column 1
    table->setItem(0, 1, new SpreadSheetItem("Temps"));
    ...
    table->setItem(1, 1, new SpreadSheetItem());
    table->setItem(2, 1, new SpreadSheetItem("timer"));
    table->setItem(3, 1, new SpreadSheetItem("timer"));
    ...
    // column 2
    table->setItem(0, 2, new SpreadSheetItem("Distance"));
    ...
    table->setItem(1, 2, new SpreadSheetItem("distance_joueur_1"));
    table->setItem(2, 2, new SpreadSheetItem("distance_joueur_2"));
    table->setItem(3, 2, new SpreadSheetItem("distance_ballon"));
    ...
    // column 3
    table->setItem(0, 3, new SpreadSheetItem("Vitesse"));
    ...
    table->setItem(1, 3, new SpreadSheetItem("vitesse_joueur1"));
    table->setItem(2, 3, new SpreadSheetItem("vitesse_joueur2"));
    table->setItem(3, 3, new SpreadSheetItem("vitesse_ballon"));
    ...
    // column 4
    table->setItem(0, 4, new SpreadSheetItem("Retard"));
    ...
    table->setItem(1, 4, new SpreadSheetItem("i don't know"));
    table->setItem(2, 4, new SpreadSheetItem("i don't know"));
    table->setItem(3, 4, new SpreadSheetItem("i don't know"));
